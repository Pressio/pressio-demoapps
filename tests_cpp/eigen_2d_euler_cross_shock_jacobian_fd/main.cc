...
int main()
{
  ...
  constexpr auto invFluxScheme   = pda::InviscidFluxReconstruction::FirstOrder;
  auto appObj = pda::create_cross_shock_problem_eigen(meshObj, invFluxScheme,
						      0.1, /*density*/
						      10., /*inlet X vel*/
						      1. /*bottom yVel*/);
