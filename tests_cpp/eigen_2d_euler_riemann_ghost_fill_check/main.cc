...
bool test_full_s3()
{
  ...
  const auto meshObj = pda::load_cellcentered_uniform_mesh_eigen("./mesh_s3");
...
bool test_sample_s5()
{
  ...
  std::map<int, std::array<double, 8>> goldL;
  goldL[0]  = {0, 0, 0, 0, 1, 1, 1, 1};
  goldL[21] = {21, 21, 21, 21, 22,22,22,22};
  goldL[22] = {v,v,v,v, 21,21,21,21};
  goldL[42] = {42,42,42,42, 43,43,43,43};

  std::map<int, std::array<double, 8>> goldF;
  goldF[37] = {v,v,v,v, 45,45,45,45};
  goldF[42] = {42,42,42,42,34,34,34,34};
  goldF[45] = {45,45,45,45,37,37,37,37};
  goldF[49] = {49,49,49,49,41,41,41,41};

  std::map<int, std::array<double, 8>> goldR;
  goldR[7]  = {7,7,7,7,6,6,6,6};
  goldR[27] = {v,v,v,v,28,28,28,28};
  goldR[28] = {28,28,28,28,27,27,27,27};
  goldR[49] = {49,49,49,49,48,48,48,48};

  std::map<int, std::array<double, 8>> goldB;
  goldB[0]  = {0, 0, 0, 0, 8,8,8,8};
  goldB[3]  = {3,3,3,3,11,11,11,11};
  goldB[7]  = {7,7,7,7,15,15,15,15};
  goldB[11] = {v,v,v,v, 3,3,3,3};
