...
#ifndef PRESSIODEMOAPPS_MIXIN_CELL_VELOCITY_HPP_
#define PRESSIODEMOAPPS_MIXIN_CELL_VELOCITY_HPP_
...
struct CellVelocity<Parent, 1, VeloType, ScalarType> : Parent
{
private:
  VeloType & m_V;
  ScalarType m_hInv;
