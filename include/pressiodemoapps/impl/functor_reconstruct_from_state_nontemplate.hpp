...
template<class ...Args> struct _ReconstructorMembersNonTemplate;
...
template<
  ...
  class MeshType
  >
struct _ReconstructorMembersNonTemplate<ReconstructedValueType, DataType, MeshType>
{
  _ReconstructorMembersNonTemplate() = delete;

  _ReconstructorMembersNonTemplate(const int axis,
  ...
  _ReconstructorMembersNonTemplate(ReconstructionScheme recEn,
			const DataType & functionValues,
			const MeshType & meshObj,
			ReconstructedValueType & uMinusHalfNeg,
			ReconstructedValueType & uMinusHalfPos,
			ReconstructedValueType & uPlusHalfNeg,
			ReconstructedValueType & uPlusHalfPos)
    : _ReconstructorMembersNonTemplate(1, /* default axis is 1 */
...
template<
  ...
  >
struct _ReconstructorMembersNonTemplate<
...
class ReconstructorForDiscreteFunctionNonTemplate;
...
class ReconstructorForDiscreteFunctionNonTemplate<
  ...
  > : public _ReconstructorMembersNonTemplate<ReconstructedValueType, DataType, MeshType>
{
  using members_t = _ReconstructorMembersNonTemplate<ReconstructedValueType, DataType, MeshType>;

public:
  template<typename ...Args>
  ReconstructorForDiscreteFunctionNonTemplate(Args && ... args)
...
class ReconstructorForDiscreteFunctionNonTemplate<
  ...
  > : public _ReconstructorMembersNonTemplate<ReconstructedValueType, DataType, MeshType, ReconstructedGradType>
{
  using members_t = _ReconstructorMembersNonTemplate<ReconstructedValueType, DataType,
...
class ReconstructorForDiscreteFunctionNonTemplate<
  ...
  > : public _ReconstructorMembersNonTemplate<ReconstructedValueType, DataType, MeshType, ReconstructedGradType>
{
  using members_t = _ReconstructorMembersNonTemplate<
    ReconstructedValueType, DataType, MeshType, ReconstructedGradType>;
